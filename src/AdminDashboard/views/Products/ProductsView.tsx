                        ...
                        <div className="space-y-4">
                          <div className="flex gap-4">
                            ...
                            <div className="flex-1 flex items-center gap-2 mt-6">
                              <input type="checkbox" name="inStock" checked={addProductForm.inStock} onChange={handleAddProductChange} className="h-4 w-4 text-green-600 border-gray-300 rounded accent-green-600" />
                              <label className="text-sm text-gray-700">In Stock</label>
                            </div>
                            <div className="flex-1 flex items-center gap-2 mt-6">
                              <input type="checkbox" name="isBestSeller" checked={addProductForm.isBestSeller} onChange={handleAddProductChange} className="h-4 w-4 text-green-600 border-gray-300 rounded accent-green-600" />
