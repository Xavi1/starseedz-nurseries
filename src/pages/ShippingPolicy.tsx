  ...
  return (
    <div className="min-h-screen bg-green-50 py-12 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-8">
        <h1 className="text-3xl font-bold text-black-700 mb-8 text-center">Shipping Policy</h1>
        <div className="space-y-6 text-gray-700">
          ...
          <h2 className="text-xl font-semibold text-black-700 mb-2">Delivery Area</h2>
          ...
          <h2 className="text-xl font-semibold text-black-700 mb-2">Processing Time</h2>
