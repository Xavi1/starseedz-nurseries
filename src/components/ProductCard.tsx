...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return <div className="group relative bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
      <div className="relative">
        ...
        {product.isNew && <div className="absolute top-2 left-2 bg-green-600 text-white text-xs px-2 py-1 rounded">
            New Arrival
          </div>}
        {product.isBestSeller && <div className="absolute top-2 left-2 bg-yellow-500 text-white text-xs px-2 py-1 rounded">
            Best Seller
          </div>}
      ...
      <div className="p-4">
        ...
        <div className="mt-1 flex items-center">
          {[...Array(5)].map((_, i) => <svg key={i} className={`h-4 w-4 ${i < product.rating ? 'text-yellow-400' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20">
