...
export const allProducts: ShopProduct[] = [
  ...
  },
  {
    ...
    name: 'Chive',
    price: 60.0,
    image: `${import.meta.env.BASE_URL}img/chives.webp`,
    category: ['Herbs'],
    rating: 4,
  },
  {
    ...
    name: 'Fine Thyme',
    price: 60.0,
    image: `${import.meta.env.BASE_URL}img/thyme.webp`,
    category: ['Herbs'],
    rating: 4,
  },
  {
    ...
    name: 'Pimento',
    price: 60.0,
    image: `${import.meta.env.BASE_URL}img/pimento.webp`,
    category: ['Peppers'],
    rating: 5,
  },
  {
    ...
    name: 'Chilli pepper',
    price: 60.0,
    image: `${import.meta.env.BASE_URL}img/chilli.webp`,
    category: ['Peppers'],
    rating: 4,
    isNew: true,
  },
  {
    ...
    name: 'Kale',
    price: 50.0,
    image: `${import.meta.env.BASE_URL}img/kale.webp`,
    category: ['Vegetables', 'Leafy Crops'],
    rating: 4,
    isBestSeller: true,
  },
  ...
  },
  {
    ...
    price: 30.0,
    image: `${import.meta.env.BASE_URL}img/basil.webp`,
    category: ['Herbs'],
    rating: 4,
  },
  {
